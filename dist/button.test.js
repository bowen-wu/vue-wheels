...
},{"./bundle-url":56}],52:[function(require,module,exports) {
var Vue // late bind
var version
...
//
//
        var $cd06b1 = exports.default || module.exports;
      
      if (typeof $cd06b1 === 'function') {
        $cd06b1 = $cd06b1.options;
      }
    
        /* template */
        Object.assign($cd06b1, (function () {
          var render = function() {
  var _vm = this
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$cd06b1', $cd06b1);
          } else {
            api.reload('$cd06b1', $cd06b1);
          }
        }
...
},{"./svg.js":61,"_css_loader":50,"vue-hot-reload-api":52,"vue":11}],13:[function(require,module,exports) {
'use strict';
...
//
//
        var $0a8aa0 = exports.default || module.exports;
      
      if (typeof $0a8aa0 === 'function') {
        $0a8aa0 = $0a8aa0.options;
      }
    
        /* template */
        Object.assign($0a8aa0, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      _vm.loading
        ? _c("g-icon", {
            ...
            attrs: { name: "loading", "icon-position": _vm.iconPosition }
          })
        : _vm._e(),
      _vm._v(" "),
      _vm.icon && !_vm.loading
        ? _c("g-icon", {
            staticClass: "icon",
            attrs: { name: _vm.icon, "icon-position": _vm.iconPosition }
          })
        : _vm._e(),
      _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$0a8aa0', $0a8aa0);
          } else {
            api.reload('$0a8aa0', $0a8aa0);
          }
        }
...
},{"./icon":48,"_css_loader":50,"vue-hot-reload-api":52,"vue":11}],1:[function(require,module,exports) {
'use strict';
...
describe('Button', function () {
    ...
    it('setting loading', function () {
        ...
        // 断言
        var useElement = vm.$el.querySelectorAll('use');
    ...
    it('icon default order is 0', function () {
        // 实例化 + 挂载
    ...
    it('setting iconPosition and change order', function () {
        // 实例化 + 挂载
        document.body.appendChild(div);
        var vm = new Constructor({
            propsData: {
    ...
    it('trigger click event handle after click button', function () {
        // 实例化 + 挂载
        var vm = new Constructor({
            propsData: {
                icon: 'settings'
...
},{"vue":11,"../src/button":13}],63:[function(require,module,exports) {
var global = arguments[3];
